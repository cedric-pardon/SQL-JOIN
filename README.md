...
mysql> SELECT lastname, firstname, role, name FROM player JOIN wizard ON wizard.id=player.wizard_id JOIN team ON team.id=player.team_id ORDER BY name, role, lastname, firstname;
+-----------------+-------------+--------+------------+
...
mysql> SELECT firstname, lastname FROM player JOIN  wizard ON wizard.id=player.wizard_id WHERE role='seeker' ORDER BY lastname,firstname;
+-----------+------------+
| firstname | lastname   |
+-----------+------------+
| Cuthbert  | Binns      |
...
mysql> SELECT firstname, lastname FROM wizard LEFT JOIN player ON wizard.id=player.wizard_id WHERE role IS NULL;
+-----------+----------+
| firstname | lastname |
+-----------+----------+
| Terry     | Boot     |
